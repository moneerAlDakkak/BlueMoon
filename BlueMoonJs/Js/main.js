...
export function translateBM2To(language) {
  ...
  if (html.getAttribute('lang') === 'ar') {
    ...
    container.innerHTML = container.innerHTML.replace('is the first of the BlueMoon series which works on simplifying and organizing computer science topics<br> <span>BlueMoonJs</span> is your Javascript guide, here you can find the Js information when you drop it', 'هو الأول في سلسلة BlueMoon التي تهدف إلى تبسيط و تنظيم مواضيع متعلقة بعلوم الحاسوب <br><span>BlueMoonJs</span> هو دليل لغة <bdi>JavaScript</bdi> الخاص بك, هنا يمكنك إيجاد المعلومة عندما تضيعها.');
