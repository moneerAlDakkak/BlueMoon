        ...
        <ol>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <code>random() </code> : returns a random number which is equal to or greater than 0 but never equal to or greater than 1 <br>

                        <code class="full">
                            <em>/* this is a code that results a random number between 1 and 10 : */</em>

                            math.floor(<span>math.random() * 10 + 1</span>)
                        </code>
...
document.getElementById('string').innerHTML = mainStructure;
